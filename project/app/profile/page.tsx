        ...
        <div className={'flex flex-col '}>
            ...
            <section className='flex flex-col bg-theme_gray w-8/10 '>
                ...
                <div className={'flex-auto flex flex-col text-[1.5rem]'}>
                    Links:
                    <a href={user_info['instagram']? user_info['instagram']: ''}><img alt={'Instagram Link'} className={'flex-auto max-w-10'} src={'instagram.jpg'}/></a>
                    <a href={user_info['twitter']? user_info['twitter']: ''}><img alt={'Twitter Link'} className={'flex-auto max-w-10'} src={'twitter.png'}/></a>
                    <a href={user_info['facebook']? user_info['facebook']: ''}><img alt={'Facebook Link'} className={'flex-auto max-w-10'} src={'facebook.jpg'}/></a>
                </div>
            </section>
